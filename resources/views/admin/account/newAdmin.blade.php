        ...
        <div class="row">
            <div class="col-6 offset-3 card p-3 shadow-sm rounded">
                ...
                <div class=" d-flex justify-content-end">
                    <a href="{{ route('accountAdminList') }}" class=" btn bg-danger my-2 w-25 rounded shadow-sm text-white"> <i
                            class="fa-solid fa-users"></i> Admin List</a>
                </div>

                <div class="card-title bg-dark text-white p-3 h5">New Admin Account</div>

                <form action="{{ route('accountNewAdmin') }}" method="post">
                    @csrf
                    <div class="card-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="confirmPassword" value="" class="form-control @error('confirmPassword') is-invalid @enderror"
